...
class TestMetrics:
    ...
    def test_function_output(self, metrics_data, epsilon):
        ...
        r_squared = compute_r_squared(x_test, y_test)
    ...
    def test_fast_metrics(self, metrics_data, gamma):
        ...
        mmd = maximum_mean_discrepancy(x_test, y_test, gamma, exact=True)
        mmd_fast = maximum_mean_discrepancy(x_test, y_test, gamma, exact=False)
