#!/bin/bash
#SBATCH --job-name=sinkhorn_dryrun
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
#SBATCH --output=/lustre/groups/ml01/workspace/karthik.viswanathan/pancellflow/logs/sinkhorn_dryrun_%j.out
#SBATCH --error=/lustre/groups/ml01/workspace/karthik.viswanathan/pancellflow/logs/sinkhorn_dryrun_%j.err
